...
TEST_CASE("Inactive middle layer + multizone perforation",
          "[integration][inactive-cells][val-019]") {
    using Catch::Approx;
...
TEST_CASE("Inactive middle layer + multizone perf - CSV export",
          "[.visual][inactive-cells][val-019]") {
    constexpr size_t Nx = 5, Ny = 5, Nz = 3;
    constexpr double Lx = 50.0, Ly = 50.0, hz = 10.0;
    constexpr double P_init_atm = 200.0;
    constexpr double oil_sat = 0.8;
