...
**Статус проекта:** 294 теста (Catch2), все проходят в Release (~122 сек). CPR-солвер, 3D сетки, переменный дебит, 6 standalone examples. AMGCL как git submodule (форк). Текущая фаза: стабилизация ядра.
