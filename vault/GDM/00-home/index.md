...
- [[val-022 inactive well cell perf]] — VAL-022: перфорации во всех слоях фильтруются при неактивном k=0
...
- [[val-022 inactive well cell perf]] — self-consistency: перфорации во всех слоях фильтруются при неактивном k=0
